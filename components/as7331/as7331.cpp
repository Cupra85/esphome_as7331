...
/* =========================================================
 * Basis-LSB-Werte (nW/cm² per count)
...
static inline float int_time_factor(uint8_t int_time) {
  // Integration Time skaliert invers binär
...
void AS7331Component::setup() {
  ...
  ESP_LOGI(TAG, "AS7331 running (simplified LSB, Auto-Gain enabled)");
}
...
void AS7331Component::update() {
  ...
  // SparkFun/WHO-ähnlicher UV-Index
